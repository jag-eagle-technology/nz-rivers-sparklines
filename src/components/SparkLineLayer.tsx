...
const SparkLineLayer: React.FC<SparkLineLayerProps> = ({
    mapView,
    layerId,
    data,
}) => {
    ...
    const drawLayer = async () => {
        ...
        try {
            ...
            sparkLineLayer.renderer = 
            const sparkLineLayer = await new FeatureLayer({
                url:
                    'https://services.arcgis.com/hLRlshaEMEYQG5A8/arcgis/rest/services/West_Coast_River_Gauges_Sparklines_Dev/FeatureServer/0',
            });
            */
